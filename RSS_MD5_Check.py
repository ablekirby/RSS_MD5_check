# A Script to get an RSS feed by name and print episode durations and MD5 hash of mp3 and jpg files
# Able Kirby
# December 28, 2021
...
# Load api key and api secret from pi.keys
with open("pi.keys") as keyfile:
